...
Rails.application.configure do
  ...
  config.action_mailer.smtp_settings = {
    ...
    port: ENV.fetch("GMAIL_PORT") { Rails.application.credentials.dig(:gmail_smtp, :port) }.to_i,
    ...
    authentication: ENV.fetch("GMAIL_AUTHENTICATION") { Rails.application.credentials.dig(:gmail_smtp, :authentication) }.to_sym,
    enable_starttls_auto: ENV.fetch("GMAIL_STARTTLS_AUTO") { Rails.application.credentials.dig(:gmail_smtp, :enable_starttls_auto) }.to_s == "true"
  }

...
class AdminOtpSessionFlowUpdatedTest < ActionDispatch::IntegrationTest
  setup do
  ...
  test "admin with OTP enabled redirects to OTP challenge after login" do
    @admin_user.update!(
    ...
    assert_redirected_to admin_user_otp_new_path(locale: :en)
  end
  ...
  test "successful OTP verification completes login" do
    ...
    # Now verify the OTP
    post admin_user_otp_create_path, params: {

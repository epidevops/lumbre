...
schedule.rules.create!(name: "Open Time Rule TTH", rule_type: "inclusion", frequency_units: "IceCube::MinutelyRule", frequency: 15, days_of_week: [ "tuesday", "thursday" ], start_date: Date.today, end_date: Date.today + 90.days, rule_hour_start: "17:15", rule_hour_end: "20:45")

%i[monday wednesday friday].each do |day|
  [ 1, 2, 3 ].sample.times do |j|
    schedule.schedule_events.create!(event_time: Date.today.next_week(day).to_s + ' 08:15:00 MST')
    schedule.schedule_events.create!(event_time: Date.today.next_week(day).to_s + ' 09:00:00 MST')
    schedule.schedule_events.create!(event_time: Date.today.next_week(day).to_s + ' 09:15:00 MST')
    schedule.schedule_events.create!(event_time: Date.today.next_week(day).to_s + ' 09:30:00 MST')
    schedule.schedule_events.create!(event_time: Date.today.next_week(day).to_s + ' 09:45:00 MST')
    schedule.schedule_events.create!(event_time: Date.today.next_week(day).to_s + ' 10:00:00 MST')
    schedule.schedule_events.create!(event_time: Date.today.next_week(day).to_s + ' 10:15:00 MST')
    schedule.schedule_events.create!(event_time: Date.today.next_week(day).to_s + ' 10:30:00 MST')
    schedule.schedule_events.create!(event_time: Date.today.next_week(day).to_s + ' 10:45:00 MST')
    schedule.schedule_events.create!(event_time: Date.today.next_week(day).to_s + ' 11:00:00 MST')
    schedule.schedule_events.create!(event_time: Date.today.next_week(day).to_s + ' 11:15:00 MST')
  end
end

%i[tuesday thursday].each do |day|
  [ 1, 2, 3 ].sample.times do |j|
    schedule.schedule_events.create!(event_time: Date.today.next_week(day).to_s + ' 17:15:00 MST')
    schedule.schedule_events.create!(event_time: Date.today.next_week(day).to_s + ' 17:30:00 MST')
    schedule.schedule_events.create!(event_time: Date.today.next_week(day).to_s + ' 17:45:00 MST')
    schedule.schedule_events.create!(event_time: Date.today.next_week(day).to_s + ' 18:00:00 MST')
